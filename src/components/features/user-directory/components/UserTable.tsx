      ...
      <table className="w-full min-w-[700px] table-fixed">
        <thead className="bg-[#2E4258] text-white">
          <tr className="flex w-full">
            ...
            <th className="flex-[0_0_35%] px-2 py-3 text-left text-xs font-normal flex items-center">
            ...
            <th className="flex-[0_0_25%] px-2 py-3 text-left text-xs font-normal hidden md:flex items-center">
              <div className="flex items-center justify-between w-full">
            ...
            <th className="flex-[0_0_16%] px-2 py-3 text-left text-xs font-normal flex items-center">
              <div className="flex items-center justify-between w-full">
                <span>Rol</span>
                <svg
                  width="12"
          ...
          {currentUsers.length > 0 ? (
            currentUsers.map((user, index) => (
              ...
              >
                ...
                <td className="flex-[0_0_35%] px-2 py-3 flex items-center">
                ...
                <td className="flex-[0_0_25%] px-2 py-3 whitespace-nowrap hidden md:flex items-center">
                  <div className="text-xs text-[#3B5571] truncate">
                    {user.email}
                  </div>
                </td>
                <td className="flex-[0_0_16%] px-2 py-3 whitespace-nowrap flex items-center">
