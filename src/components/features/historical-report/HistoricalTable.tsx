...
export function HistoricalTable({ records }: HistoricalTableProps) {
	return (
			...
			<table className="w-full table-fixed min-w-[2000px]">
				...
				<tbody className="bg-white">
					{records.map((record, index) => (
						<tr key={record.id} className={`flex w-full ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-gray-100 border-b border-gray-200`}>
							<td className="w-[60px] px-2 py-3 flex items-center flex-shrink-0">
								<input type="checkbox" className="w-3 h-3 bg-white rounded-sm border border-gray-300" />
							</td>
							<td className="w-[80px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.id}</div>
							</td>
							<td className="w-[120px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.matricula}</div>
							</td>
							<td className="w-[120px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.expediente}</div>
							</td>
							<td className="w-[180px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.nombre}</div>
							</td>
							<td className="w-[200px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.email}</div>
							</td>
							<td className="w-[140px] px-2 py-3 flex items-center flex-shrink-0">
							<span className={`px-2 py-1 rounded-2xl text-xs font-light ${
							...
							<td className="w-[80px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.nivelIngles}</div>
							</td>
							<td className="w-[120px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.planEstudios}</div>
							</td>
							<td className="w-[100px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.creditos}</div>
							</td>
							<td className="w-[80px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.sexo}</div>
							</td>
							<td className="w-[80px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.nip}</div>
							</td>
							<td className="w-[140px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.fechaNacimiento}</div>
							</td>
							<td className="w-[120px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.tipoAlumno}</div>
							</td>
							<td className="w-[140px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.promedioGeneral}</div>
							</td>
							<td className="w-[140px] px-2 py-3 flex items-center flex-shrink-0">
								<div className="text-xs text-[#3B5571] truncate">{record.horarioPerido}</div>
							</td>
							<td className="w-[100px] px-2 py-3 flex items-center flex-shrink-0">
